...
@interface ACMultiplayerQuizClient : UIViewController <GKMatchDelegate, ACMultiplayerEndDelegate, UIAlertViewDelegate>
@property (nonatomic, strong) GKMatch *match;
@property (nonatomic, strong) NSString *hostPlayerID;
@property (nonatomic, strong) NSString *selfPlayerID;
@property (nonatomic) BOOL weAreHosting;
@property (nonatomic, strong) NSArray *playerData;
@property (nonatomic) BOOL hasMultiplayerQuestionList;
@property (nonatomic) BOOL hasLoadedGame;
@end
